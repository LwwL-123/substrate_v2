...
use primitives::p_resource_order::OrderInterface;
...
pub struct oderInterface;
impl<T: Config> OrderInterface for oderInterface {
...
impl pallet_resource_order::Config for Test {
	...
	type OrderInterface = ();
	type BlockNumberToNumber = ();
	type NumberToBalance = ();
	type BalanceToNumber = ();
